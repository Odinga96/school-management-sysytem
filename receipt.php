...
<div class="container-fluid">
	<p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'ROYAL JUNIOR ACADEMY' ?></b></p>
        <p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'Contact: +254 700 262 352, +254 726 672 694' ?></b></p>
        <p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'P.O BOX 125-40139 AKALA, Email Address: royaljunioredu@gmail.com' ?></b></p>
        <p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'SCHOOL OFFICAL RECEIPT' ?></b></p>
	<hr>
	<div class="flex">
		<div class="w-50">
			<p>Admission No: <b><?php echo $ef_no ?></b></p>
		...
		<div class="w-50">
			...
			<p>Payment Mode: <b><?php echo isset($pay_arr[$_GET['pid']]) ? $pay_arr[$_GET['pid']]['remarks']: '' ?></b></p>
		</div>
		<?php endif; ?>
	</div>
	<hr>
...
<p><b> </b></p>
	<table class="wborder">
		<tr>
			<td width="50%">
				<p><b>Receiving Officer Name:</b></p>
                                <p><b>Officer's Signature:</b></p>
				<p><b>Accounts Clerk/Headteacher</b></p>
                                <p><b>Official Stamp </b></p>
				<hr>
				<table width="100%">
...
<div class="container-fluid">
	<p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'PAYMENTS DETAILS' ?></b></p>
        <p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'M-Pesa Account Number: 0700 262 352 (Rose Aketch)' ?></b></p>
        <p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'KCB, Bondo Branch, Account No. 1141953420 (Josphat Adieno)' ?></b></p>
	<p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'Equity Bank, Bondo Branch, Account No. 0750279326246-Royal Junior Education' ?></b></p>
        <p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Payments" : 'SCHOOL MOTTO : IN CHRIST WE EXCEL' ?></b></p>
	<hr>
	<div class="flex">